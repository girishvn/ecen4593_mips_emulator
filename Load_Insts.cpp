...
uint32_t program_image[] = {
        ...
        0x24420004,   // 	addiu	v0,v0,4 //GIRISH INSERT
        0x24a50004,   // 	addiu	a1,a1,4 //GIRISH INSERT
        0x1444fffb,   // 	bne	v0,a0,400840 <copy_array+0x10>
        //0x1444fffc,   // 	bne	v0,a0,400840 <copy_array+0x10> //GIRISH COMMENT
        //0x24a50004,   // 	addiu	a1,a1,4 //GIRISH COMMENT
        0x03e00008,   // 	jr	ra
        ...
        0x00000000,   // 	nop
        0x0240a020,	  // 	move $s32 to $s4 to be stored into result memory location                           PC = 170
