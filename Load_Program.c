...
//unsigned int memory[memory_size]; //Girish comment

//unsigned int program_image[memory_size] = {4000,4000,0,0,0,50,0,0,0,0, //Girish comment

unsigned int program_image[] = {4000,4000,0,0,0,50,0,0,0,0, //Girish add
...
const int memory_size = sizeof(program_image) / sizeof(program_image[0]); //Girish add
unsigned int memory[memory_size]; //Girish add
